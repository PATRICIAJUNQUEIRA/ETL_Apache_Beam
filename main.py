...
def trata_datas(elemento):
    ...
    Retorna o mesmo dicionário com o mesmo campo
    """
...
def chave_uf(elemento):
    ...
    Retornar uma tupla com oo estado (UF) e o elemento (UF), dicionário
    """
    chave = elemento['uf']
...
def casos_dengue(elemento):
    """
    Recebe uma tupla ('RS', [{}, {}])
    Retornar uma tupla ('RS-2024-12', 8.0)
    """
...
def arredonda(elemento):
    ...
    Retorna uma tupla com valor arredondado ('PA-2019-06', 2364.0)
    """
    chave, mm = elemento
...
def arredonda(elemento):
    """
    Recebe uma tupla ('PA-2019-06', 2364.0000000003)
...
def descompactar_elementos(elem):
    """
    Receber um tupla ('CE-2025-11', {'chuvas': [0.4], 'dengue': [21.0]})
    Retornar uma tupla ('CE', '2025','11', '0.4', '21.0')
    """
    chave, dados = elem
...
chuvas = (
    ...
    | "Soma dos casos de chuvas pela chave" >> beam.CombinePerKey(sum)
...
resultado = (
    ...
    #|"Mostra resultados da união" >> beam.Map(print)
)
